...
* The original package name 'com.demo.foodordering.food-ordering' is invalid and this project uses 'com.demo.foodordering.food_ordering' instead.
...
* [Prometheus](https://docs.spring.io/spring-boot/docs/3.2.8/reference/htmlsingle/index.html#actuator.metrics.export.prometheus)
